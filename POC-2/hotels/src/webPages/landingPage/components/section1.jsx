...
export let SectionOneComp = () => {
    ...
    <section className="section-1">
      <div className="section1_parent-div">
                ...
                <button id="discoverbutton" onclick=" window.location.href='hotel-listing-page.html' ">Discover
                    Now</button>
      </div>
      <div className="section1_parent-div section1-ParentImage">
                <img id="section1_image" src="./assets/images/06.jpg" alt="image"/>
                <img className="leaves-image" src="./assets/images/yellowleaf2.svg" alt="image"/>
